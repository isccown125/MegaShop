...
export class Basket extends Component {
    ...
    update() {
        ...
        this.items.forEach((el, index) => {
            ...
            const btnAddProduct = this.createChild(btnContainer, 'button', [{ cssClasses: 'basket-product-item__btn-add' }, { cssClasses: 'btn-style-basket' }]);
            const btnRemoveFromBasket = this.createChild(btnContainer, 'button', [{ cssClasses: 'basket-product-item__btn-remove' }, { cssClasses: 'btn-style-basket' }]);
